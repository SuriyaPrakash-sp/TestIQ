...
def run_pipeline(
    ...
    result = PipelineResult(
        ...
        low_coverage_bins=analysis["low_cov_bins"].round(4).to_dict("records"),
        weakest_bins_by_weighted_priority=analysis["weakest_bins"].round(4).to_dict("records"),
        best_seeds_global=analysis["best_seeds"].round(4).to_dict("records"),
        seed_bin_matrix_sample=analysis["seed_bin_matrix"].round(4).to_dict("records"),
